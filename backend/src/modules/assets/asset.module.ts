...
import { AssetController, PublicAssetController, PublicQrController } from './controllers/asset.controller';
...
@Module({
  ...
  controllers: [AssetController, PublicAssetController, PublicQrController],
