...
export class Schema1762504362129 implements MigrationInterface {
    name = 'Schema1762504362129'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "service_requests" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "company_id" uuid NOT NULL, "asset_id" uuid NOT NULL, "client_id" uuid, "channel" "public"."service_requests_channel_enum" NOT NULL, "type" "public"."service_requests_type_enum" NOT NULL, "description" text NOT NULL, "media" jsonb, "status" "public"."service_requests_status_enum" NOT NULL DEFAULT 'PENDING', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "companyId" uuid, "assetId" uuid, CONSTRAINT "PK_ee60bcd826b7e130bfbd97daf66" PRIMARY KEY ("id"))`);
