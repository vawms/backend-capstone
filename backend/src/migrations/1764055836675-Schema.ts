...
export class Schema1764055836675 implements MigrationInterface {
    name = 'Schema1764055836675'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "companies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "logo_url" character varying, "primary_color" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "idx_assets_company_id" ON "assets" ("company_id") `);
        await queryRunner.query(`CREATE INDEX "idx_assets_qr_token" ON "assets" ("qr_token") `);
        await queryRunner.query(`ALTER TABLE "technicians" ADD CONSTRAINT "FK_74d0f81758f5a3ae3c17d0a9ced" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_requests" ADD CONSTRAINT "FK_087a394a60972ad5513650e39f7" FOREIGN KEY ("companyId") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_requests" ADD CONSTRAINT "FK_007fa1625f7e2d7c38084819c1f" FOREIGN KEY ("assetId") REFERENCES "assets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_requests" ADD CONSTRAINT "FK_0f0523ef455e70bfe9a330342cc" FOREIGN KEY ("client_id") REFERENCES "clients"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_requests" ADD CONSTRAINT "FK_58f2a97d333d8740ce83c675e41" FOREIGN KEY ("technician_id") REFERENCES "technicians"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clients" ADD CONSTRAINT "FK_fcadfe25d85cf21251273169128" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_requests" DROP CONSTRAINT "FK_0f0523ef455e70bfe9a330342cc"`);
        await queryRunner.query(`ALTER TABLE "service_requests" DROP CONSTRAINT "FK_007fa1625f7e2d7c38084819c1f"`);
        await queryRunner.query(`ALTER TABLE "service_requests" DROP CONSTRAINT "FK_087a394a60972ad5513650e39f7"`);
        await queryRunner.query(`ALTER TABLE "technicians" DROP CONSTRAINT "FK_74d0f81758f5a3ae3c17d0a9ced"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_service_requests_company_created"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."service_requests_channel_enum"`);
