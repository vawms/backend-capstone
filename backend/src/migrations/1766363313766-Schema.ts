...
export class Schema1766363313766 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_requests" ADD CONSTRAINT "FK_3ce5a8fc5aa2dafe7d10b7d8bf5" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "service_requests" ADD CONSTRAINT "FK_c439f276dab8fb3ef30413d220a" FOREIGN KEY ("asset_id") REFERENCES "assets"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_requests" DROP CONSTRAINT "FK_c439f276dab8fb3ef30413d220a"`);
        await queryRunner.query(`ALTER TABLE "service_requests" DROP CONSTRAINT "FK_3ce5a8fc5aa2dafe7d10b7d8bf5"`);
